...
export class AppointmentService {
  ...
  makeAppointment(appointment:Appointment) : Observable<any>{
    ...
    return this.http.post<Appointment>('http://localhost:7000/api/v1/appointment/makeappointment',body,{headers});
  ...
  getAllAppointment(): Observable<Appointment[]> {
    return this.http.get<Appointment[]>('http://localhost:7000/api/v1/appointment/viewallappointments');
  }  
  ...
  {
    return this.http.get<Appointment[]>('http://localhost:7000/api/v1/appointment/viewmyappointment/03');
  }
}
